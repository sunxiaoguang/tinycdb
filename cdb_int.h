...
int _cdb_make_fullwrite(struct cdb_file_writer *writer, int fd, const unsigned char *buf, unsigned len);
...
extern struct cdb_file_reader _cdb_posix_file_reader;
extern struct cdb_file_writer _cdb_posix_file_writer;
